...
export default async function GuidePage({params}:{params:Promise<{slug:string}>}){
  ...
  const articleSchema = { "@context":"https://schema.org", "@type":"Article", headline:page.title, description:page.summary, dateModified:"2026-08-04", author:{"@type":"Person",name:"Murray Newlands"}, publisher:{"@type":"Organization",name:"Open Future Forum"}, mainEntityOfPage:`https://murraylovecode.github.io/executive-community-playbook/${page.slug}/` };
